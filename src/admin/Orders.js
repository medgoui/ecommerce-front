                        ...
                        orders.map((order, i) => {
                            return (
                                <div className="mt-5" key={i} style={{ borderBottom: '5px solid indigo' }}>
                                    ...
                                    <h3 className="mt-4 mb-4 font-italic">Total products in order: {order.products.length}</h3>
                                    {order.products.map((product, ip) => (
                                        <div className="mb-4" key={ip} style={{ padding: '20', border: '1px solid indigo' }}>
